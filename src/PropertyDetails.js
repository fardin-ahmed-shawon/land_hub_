            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-8">
                        ...
                        {/* <!-- Overview bg-dark card--> */}
                        <div className="bg-dark card p-3">
                            <div className="bg-dark card-body">
                                <h3 className='bg-transparent text-white'>Overview</h3>
                                <br />
                                <div className="bg-transparent row">
                                    <div className="bg-transparent col-4 col-md-2">
                                        Updated On:
                                        <br />
                                        2nd Nov 2023
                                    </div>
                                    <div className="bg-transparent col-4 col-md-2 text-center">
                                        <svg className='bg-transparent' width="40" height="40" viewBox="0 0 798 569" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="bg-transparent col-4 col-md-2 text-center">
                                        <svg className='bg-transparent' width="40" height="40" viewBox="0 0 517 515" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="bg-transparent col-4 col-md-2 text-center">
                                        <svg className='bg-transparent' width="40" height="40" viewBox="0 0 696 525" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="bg-transparent col-4 col-md-2 text-center">
                                        <svg className='bg-transparent' width="40" height="40" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="bg-transparent col-4 col-md-2 text-center">
                                        <svg className='bg-transparent' width="40" height="40" viewBox="0 0 406 424" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <br />
                        {/* <!-- Description bg-dark card --> */}
                        <div className="bg-dark card p-3">
                            <div className="bg-dark card-body">
                                <h3 className='bg-transparent text-white'>Description</h3>
                        ...
                        <br />
                        {/* <!-- Address bg-dark card --> */}
                        <div className="bg-dark card">
                            <div className="bg-dark card-header">
                                <h3 className='bg-transparent text-white'>Address</h3>
                            </div>
                            <div className="bg-dark card-body">
                                <div className="bg-transparent row">
                                <div className="bg-transparent listing_detail wpresidence-detail-address col-md-4">
                                    <strong className='bg-transparent'>Address:</strong> Calle de Lagasca
                                </div>
                                <div className="bg-transparent listing_detail wpresidence-detail-city col-md-4">
                                    <strong className='bg-transparent'>City:</strong> <a style={{color: '#52AA5E', textDecoration: 'none'}} href="https://madrid.wpresidence.net/property_city/madrid/" rel="tag" className='bg-transparent '>Madrid</a>
                                </div>
                                <div className="bg-transparent listing_detail wpresidence-detail-area col-md-4">
                                    <strong className='bg-transparent '>Area:</strong> <a style={{color: '#52AA5E', textDecoration: 'none'}} href="https://madrid.wpresidence.net/property_area/castellana/" rel="tag" className='bg-transparent '>Castellana</a>
                                </div>
                                <div className="bg-transparent listing_detail wpresidence-detail-state-county col-md-4">
                                    <strong className='bg-transparent '>State/County:</strong> <a className='bg-transparent ' style={{color: '#52AA5E', textDecoration: 'none'}} href="https://madrid.wpresidence.net/property_county_state/comunidad-de-madrid/" rel="tag">Comunidad de Madrid</a>
                                </div>
                                <div className="bg-transparent listing_detail wpresidence-detail-zip col-md-4">
                                    <strong className='bg-transparent '>Zip:</strong> 28006
                                </div>
                                <div className="bg-transparent listing_detail wpresidence-detail-country col-md-4">
                                    <strong className='bg-transparent '>Country:</strong> Spain
                                </div>
                        ...
                        <div className="bg-dark card">
                            <div className="bg-dark card-header">
                                <h3 className='bg-transparent text-light'>Details</h3>
                            </div>
                            <div className="bg-dark card-body">
                                <div className="bg-transparent row">
                                <div className="bg-transparent listing_detail col-md-4 propertyid_display">
                                    <strong className='bg-transparent'>Property Id:</strong> 139
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property_default_price">
                                    <strong className='bg-transparent'>Price:</strong> 5.500.000 € <span className="price_label"></span>
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property_default_property_size">
                                    <strong className='bg-transparent'>Property Size:</strong> <span>250 m<sup>2</sup></span>
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property_default_lot_size">
                                    <strong className='bg-transparent'>Property Lot Size:</strong> <span>600 m<sup>2</sup></span>
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property_default_rooms">
                                    <strong className='bg-transparent'>Rooms:</strong> 3
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property_default_bedrooms">
                                    <strong className='bg-transparent'>Bedrooms:</strong> 5
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property_default_bathrooms">
                                    <strong className='bg-transparent'>Bathrooms:</strong> 3
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property-year">
                                    <strong className='bg-transparent'>Year Built:</strong> 200
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property-garage">
                                    <strong className='bg-transparent'>Garages:</strong> 1
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property-garage-size">
                                    <strong className='bg-transparent'>Garage Size:</strong> 1 car
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property-date">
                                    <strong className='bg-transparent'>Available from:</strong> 2021-09-16
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property-basement">
                                    <strong className='bg-transparent'>Basement:</strong> cement
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property-external-construction">
                                    <strong className='bg-transparent'>External construction:</strong> No
                                </div>
                                <div className="bg-transparent listing_detail col-md-4 property-roofing">
                                    <strong className='bg-transparent'>Roofing:</strong> Old
                                </div>
                                </div>
                            </div>
                            </div>
...
<div className="bg-dark card">
  <div className="bg-dark card-header">
    <h3 className='bg-transparent text-light'>Features</h3>
  </div>
  <div className="bg-dark card-body">
    <div className="bg-transparent row">
      {/* Interior Details */}
      <div className="bg-transparent col-md-6">
        <h5 className='bg-transparent'>Interior Details</h5>
        <ul className="bg-transparent list-unstyled">
          <li className='bg-transparent '><i className="bi bi-house-door"></i> Equipped Kitchen</li>
          <li className='bg-transparent '><i className="bi bi-dumbbell"></i> Gym</li>
          <li className='bg-transparent '><i className="bi bi-washing-machine"></i> Laundry</li>
          <li className='bg-transparent '><i className="bi bi-tv"></i> Media Room</li>
        </ul>
      </div>

      {/* Outdoor Details */}
      <div className="bg-transparent col-md-6">
        <h5 className='bg-transparent text-white'>Outdoor Details</h5>
        <ul className="bg-transparent list-unstyled">
          <li className='bg-transparent '><i className="bi bi-tree"></i> Back Yard</li>
          <li className='bg-transparent '><i className="bi bi-basketball"></i> Basketball Court</li>
          <li className='bg-transparent '><i className="bi bi-garage"></i> Garage Attached</li>
          <li className='bg-transparent '><i className="bi bi-hot"></i> Hot Bath</li>
          <li className='bg-transparent '><i className="bi bi-water"></i> Pool</li>
        </ul>
      </div>

      {/* Utilities */}
      <div className="bg-transparent col-md-6">
        <h5 className='bg-transparent text-light'>Utilities</h5>
        <ul className="bg-transparent list-unstyled">
          <li className='bg-transparent '><i className="bi bi-wind"></i> Central Air</li>
          <li className='bg-transparent '><i className="bi bi-lightning"></i> Electricity</li>
          <li className='bg-transparent '><i className="bi bi-thermometer"></i> Heating</li>
          <li className='bg-transparent '><i className="bi bi-fuel-pump"></i> Natural Gas</li>
          <li className='bg-transparent '><i className="bi bi-fan"></i> Ventilation</li>
          <li className='bg-transparent '><i className="bi bi-droplet"></i> Water</li>
        </ul>
      </div>

      {/* Other Features */}
      <div className="bg-transparent col-md-6">
        <h5 className='bg-transparent text-light'>Other Features</h5>
        <ul className="bg-transparent list-unstyled">
          <li className='bg-transparent '><i className="bi bi-wheelchair"></i> Chair Accessible</li>
          <li className='bg-transparent '><i className="bi bi-building"></i> Elevator</li>
          <li className='bg-transparent '><i className="bi bi-bell"></i> Smoke Detectors</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div className="card-header">
        <h3 className='bg-dark text-light'>Floor Plans</h3>
    </div>
    <div className="card-body">
        <div className="row">
            <div className="row front_plan_row">
                ...
                <div className="col-md-3 bg-dark card p-3 align-items-center">
            ...
            <div className="front_plan_row_image pt-3">
                <div className="floor_description">Living Spaces are more easily interpreted. All-In-Ones color floor plan option clearly defines your listing’s living spaces, making them obvious and clearly visible to your potential buyers/clients. Add extra value to your services. Color floor-plans show that you care about selling your client’s listing; they add a premium, high value look to any listing and can be used in your brochures, email and websites.</div>
                        ...
                        {/* <!-- Reviews --> */}
                         <div className="bg-dark card p-3">
                            <div className="bg-dark card-body">
                                <div className="bg-dark " id="property_reviews_area"><h3 className='bg-dark '>Reviews</h3>You need to <span className='bg-dark ' style={{color: '#52AA5E'}}><b>login</b></span> in order to post a review</div>
                            </div>
                         </div>
                        

                        <br />
                        {/* <!-- Similer Listing bg-dark card --> */}
                        <div className="bg-dark card p-3">
                            <div className="bg-dark card-body">
                                <h3 className='bg-dark text-light'>Similer Property Listing</h3>
                                <br />
                                <div className="row">
                                    <div className="bg-dark col-sm-6 col-md-4 wow fadeInUp" data-wow-delay="0.1s" style={{visibility: 'visible', animationDelay: '0.1s', animationName: 'fadeInUp'}}>
                                        <div className="property-item rounded overflow-hidden">
                                            <div className="position-relative overflow-hidden">
                                                ...
                                                <div style={{color: '#52AA5E'}} className="bg-dark  rounded-top position-absolute start-0 bottom-0 mx-4 pt-1 px-3">Appartment</div>
                                            </div>
                                            <div className="p-4 pb-0">
                                                <h5 style={{color: '#52AA5E', fontWeight: '700'}} className="mb-3">৳5999</h5>
                                                <a style={{color: '#000', textDecoration: 'none'}} className="text-light d-block h5 mb-2" href="">Property Title </a>
                    ...
                    <div className="col-lg-4 pt-4 pt-md-0">
                        ...
                        {/* <!-- Agent Contact bg-dark card--> */}
                        <div className="bg-dark card p-3">
                            <div className="bg-dark card-body">
                                <h3 className='bg-dark text-light'>Contact with Agent</h3>
                                <br /><br />
                                <div className="bg-dark row">
                                    <div className="bg-dark col-md-3">
                                        <img className="img-thumbnail img-fluid" src={AGENTIMG} alt="" />
                                    </div>
                                    <div className="bg-dark col-md-9">
                                        <h4 className='bg-dark '>Fardin Ahmed</h4>
                                        <h6 className='bg-dark ' style={{color: '#52AA5E'}}>Property Agent</h6>
                                    </div>
                                </div>
                                <br />
                                <form className='bg-dark '>
                                    <div className="bg-dark mb-3">
                                        <label for="name" className="bg-dark orm-label">Name</label>
                                        <input type="text" className="py-3 form-control" id="name" placeholder="Enter your name" />
                                    </div>
                                    <div className="bg-dark mb-3">
                                        <label for="email" className="bg-dark form-label">Email</label>
                                        <input type="email" className="py-3 form-control" id="email" placeholder="Enter your email" />
                                    </div>
                                    <div className="bg-dark mb-3">
                                        <label for="phone" className="bg-dark form-label">Phone</label>
                                        <input type="tel" className="py-3 form-control" id="phone" placeholder="Enter your phone number" />
                                    </div>
                                    <div className="bg-dark mb-3">
                                        <label for="description" className="bg-dark form-label">Description</label>
                                ...
                                <div className="mt-3 d-flex row">
                                    <div className="bg-dark col-6">
                                        <a style={{border: '1px solid #52AA5E'}} href="tel:+1234567890" className="text-white w-100 py-3 btn">
                                            <i className="bi bi-telephone"></i> Call
                                        </a>
                                    </div>
                                    <div className="bg-dark col-6">
                                        <a style={{border: '1px solid #52AA5E'}} href="https://wa.me/1234567890" className="text-white w-100 py-3 btn">
                        ...
                        <div className="bg-dark card p-3">
                            <div className="bg-dark card-body">
                                <div className="bg-dark widget-container advanced_search_sidebar ag_ag_dev_search_widget boxed_widget">
                                    <h3 className="widget-title-sidebar bg-dark ">Agents Search</h3>
                                    <br />
                                    <form className='bg-dark ' role="search" method="get" action="https://madrid.wpresidence.net/agents-agencies-developers-search-results/">
                                        {/* <!-- Keyword Search --> */}
                                        <div className="bg-dark mb-3">
                                            <label for="keyword_search" className="bg-dark form-label">Name</label>
                                            <input type="text" id="keyword_search" className="py-3 form-control" name="_keyword_search" placeholder="Name" />
                                        </div>
                                
                                        
                                        <div className="bg-dark mb-3">
                                            <label for="sidebar-search_post_type" className="bg-dark form-label">Agent Type</label>
                                        ...
                                        <div className="bg-dark mb-3">
                                            <label for="sidebar-property_city_agent" className="bg-dark form-label">Select City</label>
                                        ...
                                        {/* <!-- Area Dropdown --> */}
                                        <div className="bg-dark mb-3">
                                            <label for="sidebar-property_area_agent" className="bg-dark form-label">Select Area</label>
                                        ...
                                        {/* <!-- Category Dropdown --> */}
                                        <div className="bg-dark mb-3">
                                            <label for="sidebar-property_category_agent" className="bg-dark form-label">Select Category</label>
                                        ...
                                        <div className="bg-dark mb-3">
                                            <label for="sidebar-property_action_category_agent" className="bg-dark form-label">Select Action Category</label>
                         ...
                         <div className="bg-dark card p-3">
                            <div className="bg-dark card-body">
                                <div className='bg-dark '>
                                    <h3 className='bg-dark'>Schedule a Tour</h3>
                                    <br />
                                    <form className='bg-dark '>
                                        {/* <!-- Date Selector --> */}
                                        <div className="bg-dark mb-3">
                                            <label for="schedule_date" className="bg-dark form-label">Select Date</label>
                                            <input type="date" id="schedule_date" className="py-3 form-control" name="schedule_date" />
                                        </div>
                                
                                        {/* <!-- Time Selector --> */}
                                        <div className="bg-dark mb-3">
                                            <label for="wpestate_schedule_tour_time" className="bg-dark form-label">Select Time</label>
                                        ...
                                        {/* <!-- Tour Options --> */}
                                        <div className="bg-dark mb-3">
                                            <label className="bg-dark form-label">Tour Type</label>
                                            <div className="bg-dark d-flex">
                                                <button style={{border: '1px solid #52AA5E'}} type="button" className="bg-dark text-light btn me-2">
                                                    <i className="bi bi-person"></i> In Person
                                                </button>
                                                <button type="button" className="bg-dark  text-light btn btn-outline-secondary">
                                        ...
                                        {/* <!-- Contact Information --> */}
                                        <h5 className='bg-dark '>Your Information</h5>
                                        <div className="alert alert-danger d-none" id="alert-agent-contact"></div>
                                        <div className="bg-dark row g-3">
                                        ...
                                        <div className="bg-dark form-check mt-3">
                                            <input type="checkbox" className="bg-dark form-check-input" id="wpestate_agree_gdpr_schedule_section" name="wpestate_agree_gdpr" />
                                            <label className="bg-dark form-check-label" for="wpestate_agree_gdpr_schedule_section">
                                                I consent to the <a style={{color: '#52AA5E', textDecoration: 'none'}} target="_blank" href="https://madrid.wpresidence.net/" className='bg-dark '>GDPR Terms</a>
                                            </label>
                                        </div>
